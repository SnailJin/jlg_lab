...
public class SesSmtpCredentialGenerator {
       private static final String KEY_ENV_VARIABLE = "s1nV1tax5Tmm9O3DaS+uY1fIi6ReVcwRyKxwKA+l"; // Put your AWS secret access key in this environment variable.
